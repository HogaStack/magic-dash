...
class LoginLogs(BaseModel, table=True):
    """SQLModel版登录日志表模型"""
    ...
    ip: str = Field(sa_column=Column(String(255), nullable=False))
    ...
    login_datetime: datetime = Field(sa_column=Column(DateTime, nullable=False))
