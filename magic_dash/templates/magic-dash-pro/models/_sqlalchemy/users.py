...
class Users(BaseModel):
    ...
    user_email: Mapped[str] = mapped_column(String(255), nullable=True, unique=True)
    user_role: Mapped[str] = mapped_column(String(255), default=AuthConfig.normal_role)
    department_id: Mapped[str] = mapped_column(String(255), nullable=True)
